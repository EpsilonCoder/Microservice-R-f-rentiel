...
/**
 * REST controller for managing {@link gouv.sn.domain.Commune}.
 */
@RestController
@RequestMapping("/api")
public class CommuneResource {
    ...
    private static final String ENTITY_NAME = "referentielCommune";
     ...
     */
    @GetMapping("/communes")
    public ResponseEntity<List<Commune>> getAllCommunes(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
