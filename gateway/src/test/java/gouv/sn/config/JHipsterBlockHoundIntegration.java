...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("gouv.sn.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("gouv.sn.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
